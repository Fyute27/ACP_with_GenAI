...
def refactored_main():
    ...
    print(bob_order.receipt())

    charlie = PlatinumCustomer("Charlie")
    ...
    print(charlie_order.receipt())

    dana = SilverCustomer("Dana")
